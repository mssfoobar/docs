      ...
      "docusaurus-plugin-openapi-docs",
      {
        ...
        config: {
          ucs: {
            ...
            outputDir: "docs/40_modules/30_ucs/Universal Comms API/v1",
            version: "1",
            label: "v1",
            ...
            versions: {
              2: {
                ...
                outputDir: "docs/40_modules/30_ucs/Universal Comms API/v2",
                label: "v2",
          ...
          unh: {
            ...
            outputDir: "docs/40_modules/80_unh/UNH API",
            sidebarOptions: {
              groupPathsBy: "tag",
            },
            hideSendButton: true,
