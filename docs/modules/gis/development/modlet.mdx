...
-   [`MapSingleEntityProvider`](#mapsingleentityprovider-component)
...
be provided as children. See [`MapXyzSourceProvider`](#mapxyzsourceprovider).
...
to also pass in a [`MapEntityProvider`](#mapentityprovider) as a child snippet to provide the necessary information for
