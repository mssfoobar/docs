...
For various configuration on Self-hosted Temporal Server, please refer to their
[Helm Chart documentation](https://github.com/temporalio/helm-charts).

## Workflow Engine Modules Configuration
...
Web UI for creating and editing workflow templates. WFD is built using web-base framework. For web-base related
configuration please refer to [web-base configuration](/docs/modules/web-base/configuration/configuration.mdx).
