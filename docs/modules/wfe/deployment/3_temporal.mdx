...
:::important
The `namespace` created here must be set to the `TEMPORAL_NAMESPACE` environment variable in the
[WFE, WFM & WFW configuration](/docs/modules/wfe/configuration/configuration.mdx).
:::
