...
[Quick Start](/docs/modules/wfe/quickstart/overview.mdx) dev-container local development.
:::
...
3. Workflow Designer is built using [web-base](/docs/modules/web-base/overview.md) and if you are already familiar with
...
[Quick Start Guide](/docs/modules/wfe/quickstart/quickstart.mdx).
:::
