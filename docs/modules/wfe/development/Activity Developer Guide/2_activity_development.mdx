...
`http://wf-admin.{DEV_DOMAIN}`. If you don't have it running, refer to [Prerequisites](./1_prerequisite.mdx).
:::
...
```go title="sample/helloworld/workflow.go"
...
```go title="internal/worker/activities/activities.go"
type Activities struct{}
...
![HttpCall](/img/modules/wfe/development/Activity%20Developer%20Guide/HttpCall.png)
...
:::info
Refer to [workflow execution guide](/docs/modules/wfe/development/Frontend%20Developer%20Guide/3_workflow_execution.mdx#start-workflow)
