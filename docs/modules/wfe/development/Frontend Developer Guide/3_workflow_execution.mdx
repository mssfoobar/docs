...
:::info
Refer to [retrieving workflow metadata guide](/docs/modules/wfe/development/Activity%20Developer%20Guide/2_activity_development.mdx#retrieving-workflow-metadata)
