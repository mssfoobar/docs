...
## Developing with HTTPS/SSL/TLS

To serve over HTTPS, set `server.https` to `true` in `vite.config.ts`. You will need a valid certificate. You can use
Vite's `@vite/plugin-basic-ssl` plugin to create a basic set up. For more details, see
https://vitejs.dev/config/server-options.html#server-https.
    
To use the plugin, import `@vite/plugin-basic-ssl` and include it in the plugins array:
