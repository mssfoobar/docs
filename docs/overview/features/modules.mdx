...
short name - the following list displays them in the format `Short Name - Full Name` except for thw `Web Base`.
...
tools to allow quick installation of different modules. Our web modules are distrubted as source code for complete
customizability.
