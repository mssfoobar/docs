...
:::info
[**_`GO CODING GUIDE`_**](./30_Coding%20Guides/20_golang.md#errors) already covers how to handle error. This section on
error handling is just a reiteration of it to
:::
