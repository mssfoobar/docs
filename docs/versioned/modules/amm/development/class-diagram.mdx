...
| `scan_status` | `string` | The status of the scan, for example: `pending`, `success`, `failed`. |
| `index_status` | `string` | The status of the index, for example: `pending`, `success`, `failed`. |
