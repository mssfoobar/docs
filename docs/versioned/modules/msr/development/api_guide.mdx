...
| table_name      | string | The source table name           |
...
### 8. Count active sessions

Returns the current number of active sessions in the system.
...
| Name          | Type   | Description                               |
| ------------- | ------ | ----------------------------------------- |
| active_count  | number | The current number of active sessions     |
