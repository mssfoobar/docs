...
| DATA_RETENTION_CRON_EXPRESSION   | `0 3 * * *`        | STRING      | Cron expression for automated CDC cleanup and snapshot refresh (default: daily at 3am)                                                     |
| EARLIEST_VALID_TIMESTAMP         | `1900-01-01T00:00:00Z` | STRING  | Optional RFC3339 timestamp defining the earliest data available for replay in UI. Takes precedence over automatic snapshot cutoff detection          |
