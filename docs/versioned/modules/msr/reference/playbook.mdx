...
**Concept:** Same as Standard Recovery, but specify a target timestamp instead of "current time"

**Key difference:**
- Use Kafka tools to find the offset for your target timestamp (e.g., "2025-10-27 10:00:00")
- Reset consumer group to that offset
- Follow Standard Recovery steps - replay will stop at current time
...
### Kafka Retention vs. MSR Configuration
