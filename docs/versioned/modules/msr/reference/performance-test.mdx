...
- Resource metrics:
  - MSR_APP: 
  ![MSR app metrics](@site/static/img/modules/msr/monitor_dev_msr_app.png)
  - Timescaledb:
  ![Timescaledb metrics](@site/static/img/modules/msr/monitor_dev_timescaledb.png)
...
- Resource metrics:
- MSR_APP: 
![MSR app metrics QA](@site/static/img/modules/msr/monitor_qa_msr_app.png)
- Timescaledb:
![Timescaledb metrics QA](@site/static/img/modules/msr/monitor_qa_timescaledb.png)
...
---
### High Concurrency Test (50 threads x 1 loop)
...
- MSR_APP: 
  - CPU usage: 
![MSR app CPU usage](@site/static/img/modules/msr/monitor_load_test_msr_app_cpu.png)
  - Memory usage: 
![MSR app memory usage](@site/static/img/modules/msr/monitor_load_test_msr_app_memory.png)
- Timescaledb:
  - During bump 3.6M records: MSR spike more than "1.5" CPU usage and "3GB" memory usage.
![Timescaledb metrics](@site/static/img/modules/msr/monitor_load_test_timescaledb.png)
