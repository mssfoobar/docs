...
The deployment uses the following default credentials (defined in your `.env` file):

| Service | Username | Password | Notes |
|---------|----------|----------|-------|
| MSR Database | `admin` | `P@ssw0rd` | PostgreSQL instance for MSR |
| GIS Database | `admin` | `P@ssw0rd` | Source database for CDC |
| Kafka Connect | - | - | HTTP API on port 8083 |
