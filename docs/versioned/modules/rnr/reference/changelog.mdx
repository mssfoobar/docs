...
The following is our build of the NATS server with some updated dependencies. The purpose of this is to avoid some
security issues flagged in some older dependencies that the official NATS server is built on. It is essentially
identical to the official NATS server, if the latest official NATS builds suit your needs, you should use those instead.
