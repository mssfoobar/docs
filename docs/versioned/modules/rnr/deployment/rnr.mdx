...
[here](https://github.com/mssfoobar/IaC/tree/main/sample-Aoh-Deployment/aoh/manifests/gis-rnr).
...
1. Deploy `debezium` for Live DB
    ...
    different `debezium.source.slot.name` and `debezium.source.publication.name`.
    ...
    **live_db_1 ConfigMap**
    ...
    data:
      application.properties: |
        ...
        debezium.source.publication.name=live_db_1_publisher
    ...
    **live_db_2 ConfigMap**
    ...
    data:
      application.properties: |
        ...
        debezium.source.slot.name=live_db_2_publisher
