...
:::info
For more information about password policies. Go to [this section](#password-policy)
:::
...
![Realm List](/img/modules/iams/overview/realm-list.png)

2. **Navigate to the Authentication Section**

In the left-hand sidebar, click on **`Authentication`**, then go to the **`Policies`** tab.

![Password Policy Setting](/img/modules/iams/overview/password-policy-setting.png)

3. **Add or Modify Password Policies**
...
- A user attribute `isDeleted` with the value `true` is added to their Keycloak profile.
...
![Realm Setting](/img/modules/iams/overview/realm-settings.png)

3. **Unmanaged Atrributes setting**
...
![Unmanaged Attributes Setting](/img/modules/iams/overview/unmanaged-attributes.png)
...
![Users List](/img/modules/iams/overview/user-list.png)

3. In the **User Details** section, set the user status back to _Enabled_.

![Users Disable Toggle](/img/modules/iams/overview/user-disable-toggle.png)

3. In the **Attributes** section, remove the `isDeleted` attribute or set its value to `false`.

![isDeleted attribute](/img/modules/iams/overview/isDeleted-attribute.png)
