...
![Select Users Menu](/img/modules/iams/overview/users-menu.png)

4. Next, Click on `Add user` button.

![Add User Button](/img/modules/iams/overview/add-user-button.png)
...
![Add User Basic Section](/img/modules/iams/overview/add-user-basic.png)
...
![Add User Membership Section](/img/modules/iams/overview/add-user-membership.png)

9. **(Optional)** Check the `Tenant Admin` option in the Permission section if you want to set `Tenant Admin` role for the account.

![Set User Permission Section](/img/modules/iams/overview/add-user-permission.png)

10. Click on `Next` button to move to the `Review and Create` tab to review your account's information.

![Review](/img/modules/iams/overview/add-user-review.png)

11. Click `Create` button.

![Create User](/img/modules/iams/overview/create-user-button.png)
...
![Select Tenants Menu](/img/modules/iams/overview/tenants-menu.png)

4. Click on the tenant you want.

![Select Tenant](/img/modules/iams/overview/tenant-list.png)

5. Click on `Select Users` button.

![Select User Button](/img/modules/iams/overview/select-user-button.png)

6. Check box the user accounts you want to add to tenant on the left column.

![Select User](/img/modules/iams/overview/select-user.png)

7. Click on `Confirm` to complete the process.

![Confirm Button](/img/modules/iams/overview/confirm-button.png)
