...
### [1.3.5](https://github.com/mssfoobar/iams/releases/tag/iams-aas/v1.3.5)
...
### [1.3.4](https://github.com/mssfoobar/iams/releases/tag/iams-aas/v1.3.4)
...
### [1.3.3](https://github.com/mssfoobar/iams/releases/tag/iams-aas/v1.3.3)
...
### [1.4.5](https://github.com/mssfoobar/iams/releases/tag/iams-keycloak/v1.4.5)
...
### [1.4.4](https://github.com/mssfoobar/iams/releases/tag/iams-keycloak/v1.4.4)
...
### [1.4.3](https://github.com/mssfoobar/iams/releases/tag/iams-keycloak/v1.4.3)
...
### [1.4.2](https://github.com/mssfoobar/iams/releases/tag/iams-keycloak/v1.4.2)
...
### [2.4.2](https://github.com/mssfoobar/iams-web/releases/tag/iams-web%2Fv2.4.2)

#### Patch Changes

- Migrate to latest web-base with SDS integration

### [2.4.1](https://github.com/mssfoobar/iams-web/releases/tag/iams-web%2Fv2.4.1)
...
### [2.4.0](https://github.com/mssfoobar/iams-web/releases/tag/iams-web%2Fv2.4.0)
...
### [2.3.0](https://github.com/mssfoobar/iams-web/releases/tag/iams-web%2Fv2.3.0)
...
### [2.0.1](https://github.com/mssfoobar/iams-web/releases/tag/iams-web%2Fv2.0.1)
...
- Add extra environment variables `PUBLIC_COOKIE_ACCESS_TOKEN` & `PUBLIC_COOKIE_REFRESH_TOKEN` to allow configuring cookie names, and improve .env.template
- Fix wrong Tailwind configuration for shadcn-svelte 5
