...
- 3b35c50: feat(error-page): standardize design; fix success toast on user creation and tenant assignment issues
- cb0e58d: chore: cleanup user and error pages

    - Remove "Customize this page" from error page
    - Allow all characters except semicolon in role names
    - Make password field optional in user form
    - Remove password validation in reset password form
