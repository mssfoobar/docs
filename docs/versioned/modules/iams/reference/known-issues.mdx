...
### Navigation Breaks After Editing a Role

**Description**
After renaming a role, the previous role detail URL becomes invalid.

**Steps to Reproduce**
1. Navigate to a role's detail page.
2. Click **Edit**, change the role name, and save.
3. Click the **Back** button.
4. A 500 error page appears due to an invalid route.

**Status**: Open
**Workaround**: Manually return to the role list and reselect the updated role.

### Incorrect Toast Message After Deleting a Group
**Description**
Upon deleting a group, the toast message incorrectly displays:

> "Tenant deleted successfully"
> instead of the correct message:
> "Group has been deleted successfully."

**Status**: Open

### Incorrect Toast Message After Creating a Resource
**Description**
After creating a resource, the toast message says:

> "Group created successfully"
> instead of the correct:
> "Resource scope has been updated successfully."
...
### Role Description Not Updated After Save
**Description**
When editing a role’s description, the field still shows the previous value after saving. The change is applied correctly but not reflected in the UI until the page is manually refreshed.

**Status**: Open
**Workaround**: Refresh the page to see the updated description.
