...
URL in `SDS_URL`. Or if you want to disable SDS and keep using the basic authentication flow of storing tokens in
browser cookies, leave the env value of `SDS_URL` empty.
