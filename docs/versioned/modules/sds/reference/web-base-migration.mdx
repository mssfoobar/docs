...
Extract the `webbase-migration.zip` file and run the script in UNIX-like shell to apply the changes, targeting your
local web-base repository root directory.
