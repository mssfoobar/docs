...
<details>
	...
	<div>
		The value defaults to "lax", however, you can also change it to "strict" or "none". Read here to learn more
		about SameSite cookie settings: https://web.dev/articles/samesite-cookies-explained.
	</div>
</details>
