...
Before you start upgrading the server, make sure you have the latest Helm chart. You can find the latest AOH Temporal
Helm chart [here](https://github.com/mssfoobar/IaC/tree/main/HelmCharts/temporalio).
