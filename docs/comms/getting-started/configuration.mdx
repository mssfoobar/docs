...
If browser cannot establish the ice canndidate pair with SFU, consider mapping external ip address to `sfu.toml` file.
...
:::info
crendentials pair are separated by '='. pion=ion means username = pion and crendential = ion
:::

## Browser Configuration

If SFU is configured to be used with stun/turn server, please specific the stun/turn in brwoser configuration.
