...
-   [Svelte & Svelte Kit](/docs/docs/overview/technologies/svelte_sveltekit)
-   [Graph QL](/docs/docs/overview/technologies/svelte_sveltekit)
-   [urql](/docs/docs/overview/technologies/svelte_sveltekit)
...
See: [Standard Response Format](/docs/40_internal_processes/10_development/60_guidelines/30_development.mdx#data-response-format)
