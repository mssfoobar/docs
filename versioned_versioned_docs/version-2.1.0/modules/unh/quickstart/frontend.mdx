...
The UNH module requires the user account to be assigned to a tenant in order to use the module. If you haven't done so, refer to [this guide](../../iams/overview/administration.mdx#set-up-user-account) for more information.
