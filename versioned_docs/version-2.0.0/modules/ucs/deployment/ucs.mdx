...
[Signal Configuration](/docs/modules/ucs/configuration/signal.mdx) section for more details.
...
Refer to [SFU Configuration](/docs/modules/ucs/configuration/sfu.mdx) section for more details.

### S3 Compatible Storage
UCS module uses Minio as S3 compatible storage. You can switch to another S3 compatible storage if needed. When
setting the Minio endpoint in [Room-Mgmt configuration](/docs/modules/ucs/configuration/room-mgmt.mdx), make sure the
