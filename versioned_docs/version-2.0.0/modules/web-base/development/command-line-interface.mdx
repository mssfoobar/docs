...
ensure you have read the [Modlet Development](../../../contributing/development/web-module-development.mdx) section
before continuing.
:::

-   **Package Name**: This corresponds to your module name, and the folder you place all your module files in
    ([for example see "bar" here](../../../contributing/development/web-module-development.mdx#cli-tool-packaging-requirements))
-   **Project Name**: The name of your project - this is always `aoh` when performing development for AGIL Ops Hub
    modules ([for example see "foo" here](../../../contributing/development/web-module-development.mdx#cli-tool-packaging-requirements)).
